...
public class DataHelpher {
	...
	public static Pessoa createPessoa() {
		return Pessoa.builder().idPessoa(pessoa1).nome("pessoa request").dataNascimento(LocalDate.parse("1998-05-14")).build();
	}
	...
	public static List<Pessoa> createListPessoas() {
		return List.of(
				Pessoa.builder().idPessoa(pessoa1).nome("Pessoa 1").dataNascimento(LocalDate.parse("2001-11-11")).build(),
				Pessoa.builder().idPessoa(pessoa1).nome("Pessoa 2").dataNascimento(LocalDate.parse("2002-02-22")).build(),
				Pessoa.builder().idPessoa(pessoa1).nome("Pessoa 3").dataNascimento(LocalDate.parse("2003-03-03")).build(),
				Pessoa.builder().idPessoa(pessoa1).nome("Pessoa 4").dataNascimento(LocalDate.parse("2004-04-14")).build());
	}
